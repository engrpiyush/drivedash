...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DrivemondException.class)
    public ResponseEntity<ApiResponse<Void>> handleDrivemondException(DrivemondException ex) {
        log.warn("DrivemondException [{}]: {}", ex.getStatus(), ex.getMessage());
