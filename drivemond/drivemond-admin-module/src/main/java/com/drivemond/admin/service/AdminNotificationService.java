package com.drivemond.admin.service;

import com.drivemond.admin.dto.NotificationDto;
import com.drivemond.admin.entity.AdminNotification;
import com.drivemond.admin.repository.AdminNotificationRepository;
...
public class AdminNotificationService {
    ...
    public NotificationDto markSeen(Long id) {
        ...
        AdminNotification notification = repository.findById(id)
                .orElseThrow(() -> DrivemondException.notFound("Notification not found"));
