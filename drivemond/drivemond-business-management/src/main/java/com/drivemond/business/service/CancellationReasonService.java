...
import com.drivemond.business.dto.CancellationReasonDto;
import com.drivemond.business.dto.CancellationReasonRequest;
import com.drivemond.business.entity.CancellationReason;
import com.drivemond.business.entity.CancellationUserType;
import com.drivemond.business.repository.CancellationReasonRepository;
...
public class CancellationReasonService {
    ...
    private CancellationReason findOrThrow(UUID id) {
        return repository.findById(id)
                .orElseThrow(() -> DrivemondException.notFound("Cancellation reason not found"));
    }
