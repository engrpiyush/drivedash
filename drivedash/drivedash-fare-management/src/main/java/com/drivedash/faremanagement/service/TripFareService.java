...
import com.drivedash.faremanagement.entity.TripFare;
import com.drivedash.faremanagement.entity.ZoneWiseDefaultTripFare;
import com.drivedash.faremanagement.repository.TripFareRepository;
import com.drivedash.faremanagement.repository.ZoneWiseDefaultTripFareRepository;
        ...
        return tripFareRepo.findByZoneIdAndVehicleCategoryId(zoneId, categoryId)
                .orElseGet(() -> {
                    ZoneWiseDefaultTripFare def = defaultFareRepo.findByZoneId(zoneId)
                            .orElseThrow(() -> DrivedashException.notFound("No fare configured for this zone"));
